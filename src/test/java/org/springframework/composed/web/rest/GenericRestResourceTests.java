...
public class GenericRestResourceTests {
	...
	public void getMessage() throws Exception {
		mockMvc.perform(get("/messages/MSG001"))
	...
	public void postMessage() throws Exception {
		mockMvc.perform(post("/messages").contentType(MediaType.TEXT_PLAIN).content("MSG002"))
	...
	public void putMessage() throws Exception {
		mockMvc.perform(put("/messages/MSG003").contentType(MediaType.TEXT_PLAIN).content("MSG003"))
	...
	public void deleteMessage() throws Exception {
		mockMvc.perform(delete("/messages/MSG003"))
				.andExpect(status().isNoContent())
				.andExpect(content().string(""));
	}
